package com.lion.inventory_app.query;

import com.lion.inventory_app.model.QProduct;
import com.lion.inventory_app.model.QStock;
import com.lion.inventory_app.model.QWarehouse;
...
public class StockQueryRepository {
    ...
    public List<Stock> search(StockSearchCondition condition) {
        ...
        builder.and(stock.product.id.eq(product.id));
        builder.and(stock.warehouse.id.eq(warehouse.id));
